...
namespace Keeper.Core.Migrations
{
    ...
    [Migration("20240620045350_DeleteDiscountPriceInProduct")]
    partial class DeleteDiscountPriceInProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Keeper.Core.Context.Models.Product", b =>
                {
                    ...
                    b.HasIndex("UPC", "BranchId")
                        .IsUnique();

                    b.ToTable("Products", "new-keeper");
                });

            modelBuilder.Entity("Keeper.Core.Context.Models.ProductDitscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductDitscounts", "new-keeper");
                });
