...
public static class OrganizationBranchDto
{
    ...
    public class Client_Search : OrganizationBranch.Search, IFilter, MainDto.IPageInfoSource;
    ...
    public class Db_Search : Db.OrganizationBranch.Search, IBranchName, MainDto.IPageInfoDb;
